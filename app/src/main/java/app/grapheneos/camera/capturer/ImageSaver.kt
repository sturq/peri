...
) : ImageCapture.OnImageCapturedCallback()
{
    ...
    private fun saveImageInner() {
        ...
        // OrchardCam: apply the iPhone-look grade to the developed JPEG before writing
        processedJpegBytes = app.grapheneos.camera.AppleLook.grade(appContext, processedJpegBytes, jpegQuality)
